...
import api from '../../api';
import { Plus, Clock, FileText, Loader2, Users, BarChart3 } from 'lucide-react';
import { motion } from 'framer-motion';

const AdminDashboard = () => {
    const [tests, setTests] = useState([]);
    const [stats, setStats] = useState({ total_tests: 0, total_students: 0, total_submissions: 0, active_tests: 0 });
                    ...
                    {tests.map((test) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-6 text-sm text-slate-500 mt-4">
                                <span className="flex items-center gap-1"><Clock size={16} /> {test.duration} mins</span>
                                <span>•</span>
